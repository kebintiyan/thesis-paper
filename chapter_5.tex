...
\chapter{Results and Analysis}	
	...
	\label{sec:demographics}
		...
		\begin{landscape}
			\begin{table} [!htbp]
				\centering
		        \captionof{table}{Demographic Characteristics} \label{tab:demographics} 
		   		\vspace{0.20cm}    
		        \begin{tabular}{|p{4 cm}R{4cm}R{4cm}R{4cm}|} %{|l|l|l}
		        	\hline 
	...
	\section{Understanding Composer Needs}
		...
		\begin{table} [H]
			\captionof{table}{Composer Responses from the Interviews} \label{tab:composer-responses}
			\vspace{0.20cm}   
	...
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{figures/affinity_diagram.png}
	...
	\end{figure} 
		...
		\newpage
		The identified needs and pain points from the composers were translated to features for the developed prototypes as shown in Tables \ref{tab:feature-translations-basic} and \ref{tab:feature-translations-advanced}. These were the bases for the user stories, also shown in Appendix \ref{sec:user_stories}.

		\begin{longtable}{|p{.5cm} p{13.5cm}|}
			\caption{Basic Feature Translations. O = Observation, C = Clarification, V = Verification, T = Translation, U = User Stories Derived.} \label{tab:feature-translations-basic} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to place a note in my composition, so that I can create my composition.
		  								\1 As a user, I want to be able to place a rest in my composition, so I can have pauses in my composition.
		  							\end{outline} \\
		  	\hline
		  	...
		  	\textbf{T:} 	& Added a feature that allowed deleting single or multiple notes and rests on the music sheet. \\
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to select a note, so that I can perform actions on it.
		  								\1 As a user, I want to be able to erase a note in my composition, so that I can make space for other notes in my composition.
		  								\1 As a user, I want to be able to select a rest, so that I can perform actions on that rest.
		  								\1 As a user, I want to be able to highlight a group of notes in my composition, so that I can perform actions on the group.
		  								\1 As a user, I want to be able to erase a highlighted group of notes in my composition, so that I can make large changes faster.
		  								\1 As a user, I want to be able to highlight a group of rests, so that I can perform actions on the group of rests.
		  								\1 As a user, I want to be able to erase a highlighted group of rests in my composition, so that I can make large changes faster.
		  							\end{outline} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to select a note, so that I can perform actions on it.
		  								\1 As a user, I want to be able to change the pitch of a note in my composition, so that I can make adjustments to my composition.
		  								\1 As a user, I want to be able to change the type of a note in my composition, so that I can make the sound longer or shorter.
		  								\1 As a user, I want to be able to select a rest, so that I can perform actions on that rest.
		  								\1 As a user, I want to be able to change a rest in my composition, so that I can make adjustments to my composition.
		  							\end{outline} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to set the key signature of my composition.
		  								\1 As a user, I want to be able to set the time signature of my composition.
		  							\end{outline} \\
		  	\hline
		\end{longtable}

		\begin{longtable}{|p{.5cm} p{13.5cm}|}
			\caption{Advanced Feature Translations. O = Observation, C = Clarification, V = Verification, T = Translation, U = User Stories Derived.} \label{tab:feature-translations-advanced} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to highlight a group of notes in my composition, so that I can perform actions on the group.
		  								\1 As a user, I want to be able to highlight a mixed group of notes and rests in my composition, so that I can perform actions on the group.
	  									\1 As a user, I want to be able to transpose a highlighted group of notes, so that I do not need to individually change the pitch of each note.
	  									\1 As a user, I want to be able to perform retrograde inversion on a group of notes, so that I do not need to invert each note individually.
	  								\end{outline} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								...
		  								\1 As a user, I want to be able to highlight a group of rests, so that I can perform actions on the group of rests.
		  								\1 As a user, I want to be able to highlight a mixed group of notes and rests in my composition, so that I can perform actions on the group.
		  								\1 As a user, I want to be able to copy a highlighted group of notes and/or rests, so that I can copy a recurring segment in my composition.
    									\1 As a user, I want to be able to cut a highlighted group of notes and/or rests, so that I can easily move a segment of my composition.
    									\1 As a user, I want to be able to paste the copied or cut group of notes and/or rests onto my composition, so that I do not need to add a recurring segment in my composition manually all the time.
		  							\end{outline} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to hear the sound of the note I just added, so that I know I've added the correct sounding note.
		  								\1 As a user, I want to be able to listen to my whole composition, so that I can hear it as a whole.
		  							\end{outline} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to add accidentals to my notes, so that I can control the pitch of my notes.
		  								\1 As a user, I want to be able to remove accidentals from my notes, so that I can control the pitch of my notes.
		  							\end{outline} \\
		  	\hline
		  	...
		  	\textbf{U:} 	& \begin{outline}
		  								\1 As a user, I want to be able to add ottavas and ottava bassas on my notes, so that I can easily change the octave of my notes
  		 				 				\1 As a user, I want to be able to remove ottavas and ottava bassas on my notes, so that I can easily change the octave of my notes
		  							\end{outline} \\
		  	\hline
		\end{longtable}
	...
	\label{sec:design}
		...
		\subsection{Initial Sketches}
			...
			\begin{figure}[H]
			    ...
			    \caption{Sketch 1 of 3 of the initial user interface and interaction design. It has a menu at the bottom that is used to input notes and rests. When a note is pressed, the note is added to the selected measure and can can be dragged to change its position on the staff. A touch-and-hold interaction is used to put dots on the notes. An additional measure can also be added by clicking the ``+'' icon found below the last measure.}
			...
			\begin{figure}[H]
			    ...
			    \caption{Sketch 2 of 3 of the initial user interface and interaction design. The sketch contains buttons that perform actions such as \textit{play}, \textit{pause}, \textit{copy}, \textit{paste}, etc. Like in the previous sketch, it also uses a menu to hold the notes but instead uses a radial menu. The menu is shown by tapping on the center of the circle. Notes can then be dragged and dropped into the music sheet.}
			...
			\begin{figure}[H]
			    ...
			    \caption{Sketch 3 of 3 of the initial user interface and interaction design. This sketch does not only contain notes and rests but also different modifiers such as \textit{accidentals}, \textit{dots}, and \textit{ottava}. By pressing a button, the menu would expand to more options based on the button pressed. The user would then be able to select various notes/rests and modifiers to apply.}
			...
			The initial sketches (see Figures \ref{fig:initial_sketches_1}, \ref{fig:initial_sketches_2}, and \ref{fig:initial_sketches_3}) were made to quickly ideate possible designs and interactions for the system. The researchers made several of these to see how different interactions would work. However, given the limited medium, only the core features (adding, editing, and deleting) were focused on. The researchers then picked the interactions and designs from the sketches that felt easiest to perform.
	...
	\section{Verification and Evaluation}
		\subsection{Usability Testing Results}
			...
			\label{sub:iteration_3}
				...
				\begin{landscape}				
					\begin{longtable}{|p{3cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{1cm}|}
						\caption{Feature Scores per Tester for Iteration 3} \label{tab:results-features-it3} \\
						  	\hline
						  	\textbf{Feature} & \textbf{T1} & \textbf{T2} & \textbf{T3} & \textbf{T4} & \textbf{T5} & \textbf{T6} & \textbf{T7} & \textbf{T8} & \textbf{T9} & \textbf{T10} & \textbf{T11}& \textbf{T12} & \textbf{T13} & \textbf{T14} & \textbf{T15} & \begin{math}\bm{\mu}\end{math} \\ \hline
		...
		\label{sec:comparative_analysis}
			...
			\subsubsection{Analysis for All Testers Across Iterations}
			...
			\subsubsection{Analysis for the Common Testers Across Iterations}
				There was a common group of five (5) testers that were present from iteration 1 to 3. This was done to allow an analysis of common samples and see if there was an improvement in the user experience for these testers. Tables \ref{tab:common-samples-it1}, \ref{tab:common-samples-it2}, and \ref{tab:common-samples-it3} show the scores given by these testers for similar features from iteration 1, 2, and 3 respectively. Note that for iteration 1 and 2, since the features were more specific, similar features were grouped into a more general description of the feature to match that of iteration 3. The average of the scores from the similar features was the score used for the general feature.

				\begin{table}[!htpb]
				  \centering
				  \captionof{table}{Common Testers Feature Scores for Iteration 1} \label{tab:common-samples-it1}
				...
				\begin{table}[!htpb]
				  \centering
				  \captionof{table}{Common Testers Feature Scores for Iteration 2} \label{tab:common-samples-it2}
				  \begin{tabular}{|p{3cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.8cm}|R{.8cm}|R{.8cm}|R{.8cm}|}
				  	\hline
				  	\textbf{Feature} & \textbf{T1} & \textbf{T2} & \textbf{T3} & \textbf{T4} & \textbf{T5} & \begin{math}\bm{\mu}\end{math} & \textbf{min} & \textbf{max} & \begin{math}\bm{\sigma}\end{math} \\ \hline
				...
				\begin{table}[H]
				  \centering
				  \captionof{table}{Common Testers Feature Scores for Iteration 3} \label{tab:common-samples-it3}
				  \begin{tabular}{|p{3cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.8cm}|R{.8cm}|R{.8cm}|R{.8cm}|}
				  	\hline
				  	\textbf{Feature} & \textbf{T1} & \textbf{T2} & \textbf{T3} & \textbf{T4} & \textbf{T5} & \begin{math}\bm{\mu}\end{math} & \textbf{min} & \textbf{max} & \begin{math}\bm{\sigma}\end{math} \\ \hline
			...
			From the group of common testers, there was only one (1) tester that was also present in iteration 4. Table \ref{tab:common-samples-all} shows the scores given by that tester across all the iterations. It can be observed that for this tester, the scores kept on increasing across all iterations, except for the delete feature in iteration 4. 

			\begin{table}[H]
			  \centering
			  \captionof{table}{Common Tester Feature Scores from Iteration 1 - 4} \label{tab:common-samples-all}
			  \begin{tabular}{|p{2.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.7cm}|R{.5cm}|R{1.4cm}|R{1.4cm}|R{1.4cm}|}
			  	\hline
			  	\textbf{Feature} & \textbf{I1} & \textbf{I2} & \textbf{I3} & \textbf{I4} & \begin{math}\bm{\mu}\end{math} & \textbf{I2 - I1} & \textbf{I3 - I2} & \textbf{I4 - I3} \\ \hline

			  	Select or highlight notes/chords 	& 3.1 & 3.9 & 4.0 & 4.0 & 3.8 & 0.8 & 0.1 & 0.0 \\ \hline
				Add notes/chords 						& 2.5 & 3.8 & 4.0 & 4.0 & 3.6 & 1.3 & 0.2 & 0.0 \\ \hline
				Edit notes/chords 						& 2.5 & 3.8 & 4.0 & 4.0 & 3.6 & 1.3 & 0.2 & 0.0 \\ \hline
				Delete notes/chords 					& 2.8 & 4.0 & 4.0 & 3.7 & 3.6 & 1.2 & 0.0 & -0.3 \\ \hline
