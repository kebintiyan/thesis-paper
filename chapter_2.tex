...
\begin{table} [!htbp]  
        ...
        \captionof{table}{Related Studies on the Mathematical Analysis of Music and Melodies} \label{tab:rsotmaomaim} 
   \vspace{0.20cm}    
        \begin{tabular}{|p{5cm}|p{3cm}|p{3cm}|p{5cm}|} %{|l|l|l}
        \hline 
...
\label{tab:rsomcrtas}        
   ...
   \vspace{0.20cm}    
        \begin{tabular}{|p{3cm}|p{4cm}|p{3cm}| p{3cm} | p{3cm}| } %{|l|l|l}
        \hline 
...
\label{tab:rsomgae}        
   ...
   \vspace{0.20cm}    
        \begin{tabular}{|p{2cm}|p{2.5cm}|p{3.2cm}| p{9.3cm} | } %{|l|l|l}
        \hline 
...
\label{tab:rsogi}        
   ...
   \vspace{0.20cm}    
        \begin{tabular}{|p{2cm}|p{2.5cm}|p{3cm}| p{4cm}| p{4cm} | } %{|l|l|l}
        \hline 
